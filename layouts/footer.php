        ...
        <div class="row container mx-auto pt-5">
          ...
          <div class="footer-one col-lg-3 col-md-6 col-sm-12">
            ...
            <div>
              ...
              <p>truongln2k@gmail.com</p>
            </div>
          </div>
          <div class="footer-one col-lg-3 col-md-6 col-sm-12">
            <h5 class="pb-2">Instagram</h5>
            <div class="row">
              <img src="assets/imgs/ap_1.jpeg" class="img-fluid w-25 h-100 m-2"/>
              ...
              <img src="assets/imgs/apm_1.jpeg" class="img-fluid w-25 h-100 m-2"/>
            </div>
          </div>
        </div>
